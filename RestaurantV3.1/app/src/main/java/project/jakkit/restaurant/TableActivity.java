...
public class TableActivity extends ActionBarActivity {
    ...
    public String upDataTableToMySQL() {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query = "UPDATE data_table SET table_status = '"+stt_table+"' WHERE table_id = '"+strTable+"'";
    ...
    private void synJSONstatusTable() {
        ...
        try {
            ...
            HttpPost objHttpPost = new HttpPost("http://192.168.1.49/get_data_table.php");
        ...
        try {
            ...
            for (int i = 0; i < objJsonArray.length(); i++) {
                ...
                String strStatus = objJSONObject.getString("table_status");
